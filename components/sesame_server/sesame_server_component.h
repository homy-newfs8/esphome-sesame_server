...
class SesameTrigger : public event::Event {
 public:
  ...
  void invoke(libsesame3bt::Sesame::item_code_t cmd, const std::string &tag,
              std::optional<libsesame3bt::history_tag_type_t> history_tag_type, float scaled_voltage,
...
class SesameServerComponent : public Component {
 ...
 private:
  ...
  void on_command(const NimBLEAddress &addr, libsesame3bt::Sesame::item_code_t cmd, const std::string tag,
                  std::optional<libsesame3bt::history_tag_type_t> history_tag_type, float scaled_voltage,
                  float scaled_voltage2, std::string_view extra);
